...
void main() {
  ...
  runApp(const GenesisBootloader());
}
  ...
  Future<void> _initApp() async {
    try {
      ...
      final prefs = await SharedPreferences.getInstance().timeout(
        ...
        onTimeout: () => throw Exception('Native iOS deadlock connecting to User Defaults. Rebooting phone usually fixes this.'),
      );
          ...
          body: Center(
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 24),
                Text(' Genesis Hub Initializing... ', style: TextStyle(color: Colors.white, fontSize: 16)),
              ],
            ),
          ),
        ),
