...
import 'package:genesis_util/features/inventory/domain/providers/inventory_providers.dart';
...
class InventoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      floatingActionButton: inventory.isEmpty
          ? null
  ...
  Future<void> _showAddItemDialog(BuildContext context, WidgetRef ref) async {
    ...
    var activeType = InventoryType.panel;
            ...
            children: [
              DropdownButtonFormField<InventoryType>(
                ...
                items: InventoryType.values
                    ...
                    .toList(),
                onChanged: (v) =>
                    setState(() => activeType = v ?? InventoryType.panel),
